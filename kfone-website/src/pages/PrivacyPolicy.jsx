...
const PrivacyPolicy = () => {
  return (
    <div className="font-body max-w-md text-sm p-4">
      <h1 className="font-bold">Privacy Policy for Kfone</h1>

      <p>
        At kfone.life, accessible from https://kfone.life, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of information that is
        collected and recorded by kfone.life and how we use it.
      </p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in kfone.life. This
      ...
      <p>
        kfone.life follows a standard procedure of using log files. These files log visitors when
      ...
      <p>
        ...
        kfone.life, which are sent directly to users&apos; browser. They automatically receive your
      ...
      <p>
        Note that kfone.life has no access to or control over these cookies that are used by
      ...
      <p>
        kfone.life&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <h2 className="font-bold">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
      ...
      <h2 className="font-bold">GDPR Data Protection Rights</h2>
      ...
      <p>
        kfone.life does not knowingly collect any Personal Identifiable Information from children
